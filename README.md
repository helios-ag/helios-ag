...
- [helios-ag/FMTinyMCEBundle](https://github.com/helios-ag/FMTinyMCEBundle) - Easily add TinyMCE WYSIWYG Text Editor to your Symfony Project (today)
...
- [helios-ag/php_rutils](https://github.com/helios-ag/php_rutils) ([1.3](https://github.com/helios-ag/php_rutils/releases/tag/1.3), 4 months ago) - php rutils - russian text handler for PHP
...
- [helios-ag/sberbank-acquiring-go](https://github.com/helios-ag/sberbank-acquiring-go) ([v0.2](https://github.com/helios-ag/sberbank-acquiring-go/releases/tag/v0.2), 1 year ago) - Клиент эквайринга Сбербанка на Go (Sberbank acquiring API client for GO)
