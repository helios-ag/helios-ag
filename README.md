...
- [helios-ag/gigachat-go](https://github.com/helios-ag/gigachat-go) - Gigachat AI Go language client (5 days ago)
...
- [helios-ag/gigachat-symfony-ai-platform-bridge](https://github.com/helios-ag/gigachat-symfony-ai-platform-bridge) - PHP Symfony compatible client for Gigachat AI (1 month ago)
...
- [helios-ag/go-logger](https://github.com/helios-ag/go-logger) ([v1.0](https://github.com/helios-ag/go-logger/releases/tag/v1.0), 2 months ago) - A unified logging library with interchangeable backends
